...
urls = [
    ...
    url(r'/login/facebook', handlers.LoginFacebookHandler, name='login-facebook'),
    url(r'/login/twitter', handlers.LoginTwitterHandler, name='login-twitter'),
    url(r'/confirm-account/(.*)', handlers.ConfirmAccountHandler, name='confirm-account'),
    url(r'/new-password', handlers.RequestNewPasswordHandler, name='new-password'),
    url(r'/reset-password/(.*)', handlers.ResetPasswordHandler, name='reset-password'),
    ...
    url(r'/post/([a-zA-Z0-9-]+)/delete', handlers.DeletePostHandler, name='post-delete'),
    url(r'/post/([a-zA-Z0-9-]+)/vote', handlers.VotePostHandler, name='post-vote'),
    url(r'/posts', handlers.PostsHandlers, name='posts'),
    url(r'/tag/([a-zA-Z0-9-]+)', handlers.TagHandler, name='tag'),
    url(r'/tag/([a-zA-Z0-9-]+)/page/([0-9]+)?', handlers.TagHandler, name='tag-page'),
    url(r'/tags', handlers.TagsHandlers, name='tags'),
    url(r'/search', handlers.SearchHandler, name='search'),
    url(r'/post/([a-zA-Z0-9-]+)/comment/new', handlers.NewCommentHandler, name='comment-new'),
    url(r'/comment/([a-z0-9]{24})/(like|dislike)', handlers.LikeCommentHandler, name='comment-like'),
    url(r'/comment/([a-z0-9]{24})/edit', handlers.EditCommentHandler, name='comment-edit'),
    url(r'/comment/([a-z0-9]{24})/delete', handlers.DeleteCommentHandler, name='comment-delete'),
